<x-site>
    <section class="banner-section">
        <div class="anim-icons">
            <div class="bg-shadow zoom-one"></div>
        </div>
        <div class="extra-large-container">
            <div class="row">
                ...
                <div class="image-column col-xl-6 d-none d-xl-block">
                    <div class="image-box">
                        <figure class="image mb-0 wow fadeInRight" data-wow-delay="1000ms">
                            {{--<img class="img-1" src="{{ asset('images/resource/man.png') }}" alt="image">--}}
                            <img class="img-2 bounce-x" src="{{ asset('images/resource/soral-panel.png') }}" alt="image">
                            <img class="img-3 bounce-y" src="{{ asset('images/resource/windmill.png') }}" alt="image">
                        </figure>
                    </div>
                </div>
            </div>
                        ...
                        <div class="content-box">
                            {{--<div class="row">
                                <div class="about-block-three col-lg-6 col-md-6 col-sm-12">
                                    <h5 class="title"><i class="icon fa fa-arrow-alt-circle-right"></i> Installed Capacity </h5>
                                    <p class="text">Lorem ipsum dolor sited amet consectetur notted</p>
                                </div>
                                <div class="about-block-three col-lg-6 col-md-6 col-sm-12">
                                    <h5 class="title"><i class="icon fa fa-arrow-alt-circle-right"></i> Save World </h5>
                                    <p class="text">Lorem ipsum dolor sited amet consectetur notted</p>
                                </div>
                            </div>--}}
            ...
            <div class="carousel-outer">
                <ul class="clients-carousel owl-carousel owl-theme">
                    @foreach(app('featured_products') as $product)
                        <div class="project-block-two p-0">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image">
                                ...
                                <div class="content-box" style="padding-left: 10px; padding-right: 10px">
                                    <span class="cat fw-bold">{{ str($product->name)->limit(23) }}</span>
                                    <button class="icon" style="margin-left: 50px"><i class="fa fa-cart-plus"></i></button>
                                </div>
                            </div>
                        </div>
                    @endforeach
    ...
    <section class="project-section-two" id="services">
        <div class="auto-container">
            <div class="sec-title text-center">
                ...
                <h2>Providing renewable energy, <br>solar power design & installation</h2>
            </div>
            <div class="carousel-outer">
    ...
    <section class="offer-section-two">
        <span class="d-none d-xl-block icon-bulb bounce-y"></span>
        <div class="auto-container">
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12">
                    <div class="inner-column">
                        ...
                        <div class="info-box">
                            ...
                            <div class="text-white"><span class="fw-bold">Full-Spectrum Development:</span>
                                Our team manages every stage of your project, from initial feasibility studies and permitting to construction, financing, and ongoing operations.
                            </div>
                        </div>
                        <div class="info-box">
                            <span class="count">3</span>
                            <div class="text-white"><span class="fw-bold">Unwavering Innovation: </span>
                                We constantly push the boundaries of solar technology, implementing the latest advancements to deliver the most efficient & cost-effective solutions.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="services-section-two">
        <div class="auto-container">
            <div class="sec-title light text-center">
                <span class="sub-title text-white">Services We're Offering</span>
                <h2 class="title">We Provide our clients <br class="d-none d-sm-block"> Best Solar Services</h2>
            </div>
            <div class="row">
