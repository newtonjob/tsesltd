...
<div id="kt_app_sidebar" class="app-sidebar  flex-column " data-kt-drawer="true" data-kt-drawer-name="app-sidebar"
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="{{ route('home') }}">
            <span class="text-white h-30px app-sidebar-logo-default" style="font-size: 30px; font-family: sans-serif; font-weight: 800">
                TSES
            </span>
        </a>
        <!--end::Logo image-->
                ...
                @can('manage-shop')
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class=" z-menu menu-link" href="{{ route('products.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                ...
                @can('manage-shop')
                    ...
                    <div class="menu-item menu-accordion">
                        <a href="{{ route('flyers.index') }}" class="menu-link">
                            ...
                            <span class="menu-title">Flyers/Ads</span>
                        </a>
                    </div>
                    <!--end:Menu item-->
                @endcan
